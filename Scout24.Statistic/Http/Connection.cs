...
namespace Scout24.Statistic
{
    ...
    public class Connection : IConnection
    {
        ...
        public ApiInfo GetLastApiInfo()
        {
            ...
            // See https://github.com/Scout24.Statistic/Scout24.Statistic.net/pull/855#discussion_r36774884
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "{0} ({1}; {2}; Scout24.Statistic {3})",
                productInformation,
