...
namespace Scout24.Statistic.Internal
{
    ...
    public class HttpClientAdapter : IHttpClient
    {
        ...
        public HttpClientAdapter(Func<HttpMessageHandler> getHandler)
        {
            ...
            //
            // Even though this is an AppDomain wide setting, the decision was made for Scout24.Statistic to
            // ensure that TLS1.2 is enabled so that existing applications using Scout24.Statistic did not need to
            // make changes outside Scout24.Statistic to continue to work with GitHub API
            //
            // *Update*
            ...
            // See https://github.com/Scout24.Statistic/Scout24.Statistic.net/issues/1914
