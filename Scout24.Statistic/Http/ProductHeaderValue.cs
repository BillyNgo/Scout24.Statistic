namespace Scout24.Statistic
{
    ...
    /// name used should represent the product, the GitHub Organization, or the GitHub username that's using Scout24.Statistic.net (in that order of preference).
    /// </summary>
    /// <remarks>
    ...
    /// so that consumers of Scout24.Statistic.net would not have to add a reference to the System.Net.Http.Headers namespace.
    ...
    public class ProductHeaderValue
    {
        ...
        /// See more information regarding User-Agent requirements here: https://developer.github.com/v3/#user-agent-required
        /// </remarks>
        /// <param name="name">The name of the product, the GitHub Organization, or the GitHub Username (in that order of preference) that's using Scout24.Statistic</param>
        ...
        /// </remarks>
        /// <param name="name">The name of the product, the GitHub Organization, or the GitHub Username (in that order of preference) that's using Scout24.Statistic</param>
        /// <param name="version">The version of the product that's using Scout24.Statistic</param>
        ...
        /// <summary>
        /// The name of the product, the GitHub Organization, or the GitHub Username that's using Scout24.Statistic (in that order of preference)
        /// </summary>
        /// <remarks>
        /// See more information regarding User-Agent requirements here: https://developer.github.com/v3/#user-agent-required
        /// </remarks>
