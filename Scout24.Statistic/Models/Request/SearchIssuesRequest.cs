...
namespace Scout24.Statistic
{
    ...
    public class SearchIssuesRequest : BaseSearchRequest
    {
        ...
        /// <summary>
        /// Gets or sets the Reviewed-By to filter issues based on
        /// </summary>
        ...
        public override IReadOnlyList<string> MergedQualifiers()
        {
            ...
            {
                parameters.Add(string.Format(CultureInfo.InvariantCulture, "reviewed-by:\"{0}\"", ReviewedBy.EscapeDoubleQuotes()));
            }
