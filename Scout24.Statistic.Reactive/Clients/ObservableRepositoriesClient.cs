...
using Scout24.Statistic.Reactive.Clients;
...
namespace Scout24.Statistic.Reactive
{
    public class ObservableRepositoriesClient : IObservableRepositoriesClient
    {
        ...
        /// <param name="owner">The owner of the repository</param>
        /// <param name="name">The name of the repository</param>
        /// <returns>All <see cref="T:Scout24.Statistic.Team"/>s associated with the repository</returns>
        ...
        /// <returns>The updated <see cref="T:Scout24.Statistic.Repository"/></returns>
